...
2. Set VSCode as your default editor in Godot (if using VSCode)
	...
	3. In exec path put your VSCode executable Path. This is usually `C:/Users/Admin/AppData/Local/Programs/Microsoft VS Code/bin/code.cmd`. If you paste in the path make sure to remove any quotes because otherwise it won't work.
